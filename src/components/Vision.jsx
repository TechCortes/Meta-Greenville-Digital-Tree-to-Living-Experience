    ...
    <section id="vision" className={styles.section}>
      <div ref={ref} className={`${styles.inner} reveal`}>
        <div className={styles.text}>
          ...
          <p className={styles.body}>Meta Greenville is a vision to create a sanctuary where nature reconnects us to clarity, community accelerates growth, and consciousness drives creation.</p>
          <p className={styles.body}>We believe the next generation of entrepreneurs and leaders must be grounded not only in technology — but in presence, awareness, and purpose.</p>
        </div>
