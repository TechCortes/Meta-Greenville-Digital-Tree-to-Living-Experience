      ...
      <div className={styles.top}>
        ...
        <div className={styles.links}>
          <div className={styles.group}>
            ...
            <a href="#vision">Vision</a><a href="#experience">Experience</a><a href="#collection">NFT Collection</a>
          </div>
          <div className={styles.group}>
            <span className={styles.groupLabel}>Connect</span>
            <a href="#community">Community</a><a href="#email">Events</a><a href="#email">Mailing List</a>
          </div>
        </div>
      </div>
