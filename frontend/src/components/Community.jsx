      ...
      <div ref={ref} className={`${styles.inner} reveal`}>
        <div className={styles.left}>
          ...
          <h2 className={styles.heading}>
            Join the Conscious<br /><em>Community</em>
          </h2>
          <p className={styles.body}>
            We host gatherings for the NYC conscious innovation community — bringing
            together those who build and lead with intention.
          </p>
