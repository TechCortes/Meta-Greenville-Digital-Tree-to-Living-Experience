...
const rarityColor = { Common:'#94a3b8', Rare:'#C6A96B', 'Super Rare':'#ff6eb4' }
  ...
  return (
    <section id="collection" className={styles.section}>
      ...
      <div className={styles.cta}>
        <a href={MARKETPLACE} target="_blank" rel="noopener noreferrer" className={styles.btn}>Browse &amp; Collect Now</a>
      </div>
    </section>
  )
}
